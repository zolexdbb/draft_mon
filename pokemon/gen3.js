...
{id:'aron',abilities:['Fermeté','Tête de Roc'],moveIds:['harden','screech','tackle','metalclaw','rocktomb','headbutt','protect','rockslide','ironhead','stridoson','takedown','irontail','irondefense','doubleedge','dragonclaw','thunderwave','brickbreak','icebeam','poweruppunch','thunderpunch','icepunch','crunch','dig','firepunch','bodyslam','endure','stealthrock','fireblast','hyperbeam','mudshot','shadowclaw','flamethrower','solarbeam','stoneedge','thunderbolt','earthquake','whirlpool','surf','dragonpulse','bulldoze','darkpulse','outrage','hydropump','focusblast','blizzard','thunder','facade','ancientpower','swagger','autotomize','curse','endeavor','mudslap','reversal','stomp','superpower','focuspunch','waterpulse','sunnyday','taunt','raindance','shockwave','sandstorm','aerialace','rest','attract','flashcannon','cut','strength','rocksmash','anchorshot','doubleironbash','gearup','smartstrike','sunsteelstrike'],
 stages:[
