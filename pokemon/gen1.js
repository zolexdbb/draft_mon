...
{id:'weedle',abilities:['Écran Poudre','Fuite'],moveIds:['poisonsting','stringshot','bugbite','facade','harden','focusenergy','poisonjab','pinmissile','rocksmash','toxic','brickbreak','protect','aerialace','swordsdance','endure','gigadrain','hyperbeam','agility','sludgebomb','solarbeam','outrage','silverwind','falseswipe','furyattack','furycutter','fellstinger','sunnyday','doubleteam','rest','attract','thief','flash','sleeptalk','swagger','cut'],
 stages:[
...
{id:'clefairy',abilities:['Joli Sourire','Médic Nature'],moveIds:['splash','tackle','fairywind','disarmingvoice','charm','drainingkiss','magicalleaf','metronome','bubblebeam','moonlight','amnesia','dazzlinggleam','mysticalfire','moonblast','airslash','doubleedge','headbutt','calmmind','thunderwave','icebeam','lightscreen','protect','playrough','thunderpunch','icepunch','swift','dig','firepunch','reflect','bodyslam','endure','stealthrock','fireblast','hyperbeam','safeguard','zenheadbutt','flamethrower','psychic','solarbeam','thunderbolt','hypervoice','shadowball','irontail','focusblast','blizzard','thunder','facade','sing','dreameater','triattack','cosmicpower','defensecurl','encore','growl','pound','sweetkiss','takedown','faketears','waterpulse','psybeam','thief','icywind','nightshade','sunnyday','raindance','brickbreak','sleeptalk','rest','imprison','skillswap','trick','knockoff','uproar','focuspunch','mistyterrain','psychup','endeavor','futuresight'],
 stages:[
...
{id:'zubat',abilities:['Attention','Infiltration'],moveIds:['absorb','screech','supersonic','gust','bite','wingattack','quickattack','whirlwind','hypnosis','haze','confuseray','poisonfang','airslash','leechlife','toxic','protect','aerialace','crunch','swift','doubleteam','nightslash','endure','gigadrain','fly','hyperbeam','knockoff','agility','sludgebomb','zenheadbutt','heatwave','shadowball','hurricane','darkpulse','curse','taunt','facade','swagger','razorwind','skyattack','aircutter','rest'],
 stages:[
...
{id:'growlithe',abilities:['Intimidation','Torche'],moveIds:['agility','bite','crunch','ember','flamewheel','howl','leer','playrough','reversal','takedown','flamethrower','doubleedge','doublekick','morningsun','thrash','charm','scaryface','protect','thief','firespin','facade','aerialace','bulldoze','swift','endure','sunnyday','dig','bodyslam','sleeptalk','rest','willowisp','dragonpulse','hypervoice','heatwave','fireblast','outrage','overheat','hyperbeam','closecombat','solarbeam','curse','sandstorm'],
 stages:[
...
{id:'geodude',abilities:['Tête de Roc','Fermeté'],moveIds:['takedown','mudslap','scaryface','protect','facade','bulldoze','mudshot','rocktomb','endure','sunnyday','sandstorm','dig','brickbreak','bodyslam','firepunch','thunderpunch','sleeptalk','rockblast','metronome','thunderwave','rest','rockslide','ironhead','irondefense','stealthrock','flamethrower','thunderbolt','fireblast','earthquake','stoneedge','focusblast','hyperbeam','thunder','curse','charge','defensecurl','tackle','rockthrow','selfdestruct','explosion','discharge','spark'],
 stages:[
