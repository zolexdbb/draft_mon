...
const ITEMS = {
  ...
  zCrystalNormal:   { name:'Normazélite',     sprite:ITEM_SPRITE('normalium-z'),   price:2200, kind:'held', category:'zcristal', zType:'normal',   desc:"Objet tenu : permet de déclencher une Capacité Z Normal en combat." },
  zCrystalCombat:   { name:'Combazélite',     sprite:ITEM_SPRITE('fightinium-z'),  price:2200, kind:'held', category:'zcristal', zType:'combat',   desc:"Objet tenu : permet de déclencher une Capacité Z Combat en combat." },
  zCrystalVol:      { name:'Aérozélite',      sprite:ITEM_SPRITE('flyinium-z'),    price:2200, kind:'held', category:'zcristal', zType:'vol',      desc:"Objet tenu : permet de déclencher une Capacité Z Vol en combat." },
  zCrystalPoison:   { name:'Toxizélite',      sprite:ITEM_SPRITE('poisonium-z'),   price:2200, kind:'held', category:'zcristal', zType:'poison',   desc:"Objet tenu : permet de déclencher une Capacité Z Poison en combat." },
  zCrystalSol:      { name:'Terrazélite',     sprite:ITEM_SPRITE('groundium-z'),   price:2200, kind:'held', category:'zcristal', zType:'sol',      desc:"Objet tenu : permet de déclencher une Capacité Z Sol en combat." },
  zCrystalRoche:    { name:'Rocazélite',      sprite:ITEM_SPRITE('rockium-z'),     price:2200, kind:'held', category:'zcristal', zType:'roche',    desc:"Objet tenu : permet de déclencher une Capacité Z Roche en combat." },
  zCrystalInsecte:  { name:'Insectozélite',   sprite:ITEM_SPRITE('buginium-z'),    price:2200, kind:'held', category:'zcristal', zType:'insecte',  desc:"Objet tenu : permet de déclencher une Capacité Z Insecte en combat." },
  zCrystalFantome:  { name:'Spectrozélite',   sprite:ITEM_SPRITE('ghostium-z'),    price:2200, kind:'held', category:'zcristal', zType:'fantome',  desc:"Objet tenu : permet de déclencher une Capacité Z Spectre en combat." },
  zCrystalAcier:    { name:'Métallozélite',   sprite:ITEM_SPRITE('steelium-z'),    price:2200, kind:'held', category:'zcristal', zType:'acier',    desc:"Objet tenu : permet de déclencher une Capacité Z Acier en combat." },
  zCrystalFeu:      { name:'Pyrozélite',      sprite:ITEM_SPRITE('firium-z'),      price:2200, kind:'held', category:'zcristal', zType:'feu',      desc:"Objet tenu : permet de déclencher une Capacité Z Feu en combat." },
  zCrystalEau:      { name:'Aquazélite',      sprite:ITEM_SPRITE('waterium-z'),    price:2200, kind:'held', category:'zcristal', zType:'eau',      desc:"Objet tenu : permet de déclencher une Capacité Z Eau en combat." },
  zCrystalPlante:   { name:'Florazélite',     sprite:ITEM_SPRITE('grassium-z'),    price:2200, kind:'held', category:'zcristal', zType:'plante',   desc:"Objet tenu : permet de déclencher une Capacité Z Plante en combat." },
  zCrystalElectrik: { name:'Voltazélite',     sprite:ITEM_SPRITE('electrium-z'),   price:2200, kind:'held', category:'zcristal', zType:'electrik', desc:"Objet tenu : permet de déclencher une Capacité Z Électrik en combat." },
  zCrystalPsy:      { name:'Psychézélite',    sprite:ITEM_SPRITE('psychium-z'),    price:2200, kind:'held', category:'zcristal', zType:'psy',      desc:"Objet tenu : permet de déclencher une Capacité Z Psy en combat." },
  zCrystalGlace:    { name:'Cryozélite',      sprite:ITEM_SPRITE('icium-z'),       price:2200, kind:'held', category:'zcristal', zType:'glace',    desc:"Objet tenu : permet de déclencher une Capacité Z Glace en combat." },
  zCrystalDragon:   { name:'Dracozélite',     sprite:ITEM_SPRITE('dragonium-z'),   price:2200, kind:'held', category:'zcristal', zType:'dragon',   desc:"Objet tenu : permet de déclencher une Capacité Z Dragon en combat." },
  zCrystalTenebres: { name:'Ténébrozélite',   sprite:ITEM_SPRITE('darkinium-z'),   price:2200, kind:'held', category:'zcristal', zType:'tenebres', desc:"Objet tenu : permet de déclencher une Capacité Z Ténèbres en combat." },
  zCrystalFee:      { name:'Nymphézélite',    sprite:ITEM_SPRITE('fairium-z'),     price:2200, kind:'held', category:'zcristal', zType:'fee',      desc:"Objet tenu : permet de déclencher une Capacité Z Fée en combat." },
  // ---- Objets de fusion Necrozma (tenus, vendus uniquement par le Marchand Itinérant) ----
  prismeCouchant:  { name:'Prisme du Couchant', sprite:ITEM_SPRITE('n-solarizer'), price:3000, kind:'held', category:'forme', formItem:true, emoji:'🌇', desc:"Objet tenu : fait fusionner Necrozma avec la lumière de Solgaleo (Crinière du Couchant, Psy/Acier)." },
  prismeAurore:    { name:"Prisme de l'Aurore", sprite:ITEM_SPRITE('n-lunarizer'), price:3000, kind:'held', category:'forme', formItem:true, emoji:'🌌', desc:"Objet tenu : fait fusionner Necrozma avec la lumière de Lunala (Ailes de l'Aurore, Psy/Spectre)." },
  ultranecrozium:  { name:'Ultranécrozium Z',  sprite:ITEM_SPRITE('ultranecrozium-z'), price:3500, kind:'held', category:'forme', formItem:true, emoji:'✨', desc:"Objet tenu : fait passer Necrozma en Ultra-Necrozma (Psy/Dragon)." },
